...
* [Streetmix](https://streetmix.net) - Design, remix and share your street. Add cycle paths, widen sidewalks or lanes, and find out how that affects your community ([source code](https://github.com/streetmix/streetmix) ⭐ 740 | 🐛 207 | 🌐 TypeScript | 📅 2026-08-19).
...
* [CommonsBooking](https://github.com/wielebenwir/commonsbooking) ⭐ 57 | 🐛 165 | 🌐 PHP | 📅 2026-08-20 - A Wordpress plugin for management and booking of commons goods especially cargo bikes.
...
* [Bikerouter](https://bikerouter.de) - Web client for BRouter, a routing engine based on OpenStreetMap.
  * [GitHub](https://github.com/nrenner/brouter-web) ⭐ 495 | 🐛 202 | 🌐 JavaScript | 📅 2026-08-14
...
* [Mobility Data Specification](https://github.com/CityOfLosAngeles/mobility-data-specification) ⭐ 747 | 🐛 24 | 📅 2026-07-09 - A data standard and API specification for mobility as a service providers, such as Dockless Bikeshare, E-Scooters, and Shared Ride providers who work within the public right of way. Developed by the City of Los Angeles.
